...
public class DivideActivity extends AppCompatActivity {
    ...
    private void checkNext() {
        if (position == 10) {
            Intent intent = new Intent(DivideActivity.this, ResultActivity.class);
    ...
    private void generateOptions(int correct) {
        ...
        do {
            btn1 = random.nextInt(20)-correct;
        } while (btn1 == correct);

        do {
            btn2 = correct + random.nextInt(20);
        } while (btn2 == correct || btn2 == btn1);

        do {
            btn3 = random.nextInt(20)-correct;
        } while (btn3 == correct || btn3 == btn1 || btn3 == btn2);

        do {
            btn4 = correct + random.nextInt(20);
